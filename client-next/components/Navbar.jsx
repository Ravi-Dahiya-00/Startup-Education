    ...
    <nav className="navbar">
      <div className="nav-container">
        ...
        <div className="nav-links-desktop">
          {navLinks.map((link) => (
            <Link key={link.name} href={link.path} className="nav-item">
              {link.name}
            </Link>
          ))}
          ...
          >
            ...
            <AnimatePresence>
              {activeDropdown === 'more' && (
                ...
                >
                  {moreLinks.map((link) => (
                    <Link key={link.name} href={link.path} className="dropdown-item">
                      {link.name}
                    </Link>
                  ))}
                </motion.div>
        ...
        <div className="nav-actions">
          ...
          {user ? (
            ...
            <>
              ...
              <Link href="/signup" className="btn-outline" style={{ textDecoration: 'none' }}>Sign Up</Link>
            </>
          )}

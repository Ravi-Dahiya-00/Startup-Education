...
const SearchResults = () => {
  ...
  const renderInternshipCard = (item) => (
    <Link href={`/internships/${item._id}`} className="search-result-card" key={item._id}>
  ...
  const renderJobCard = (item) => (
    <Link href={`/jobs/${item._id}`} className="search-result-card" key={item._id}>
  ...
  const renderCourseCard = (item) => (
    <Link href={`/courses`} className="search-result-card" key={item._id}>
  ...
  const renderCompetitionCard = (item) => (
    <Link href={`/competitions`} className="search-result-card" key={item._id}>
  ...
  const renderBlogCard = (item) => (
    <Link href={`/blogs`} className="search-result-card" key={item._id}>
  ...
  const renderScholarshipCard = (item) => (
    <Link href={`/scholarships`} className="search-result-card" key={item._id}>

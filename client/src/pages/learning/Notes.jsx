...
const Notes = () => {
  ...
  useEffect(() => {
    if (filterSubject) {
      navigate(`/notes/${filterUniversity}/${filterSubject}`);
       ...
       navigate(`/notes/${filterUniversity}`);
    }
  }, [filterUniversity, filterSubject, navigate, universityId]);
    ...
    <div className="page-container">
      ...
      <div className="page-header" style={{ textAlign: 'left', paddingBottom: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '1rem', flexWrap: 'wrap' }}>
          <Link to="/notes" style={{ textDecoration: 'none', color: view === 'universities' ? 'var(--primary)' : 'inherit', display: 'flex', alignItems: 'center' }}>
          ...
          {universityId && (
            <>
              ...
              <Link to={`/notes/${universityId}`} style={{ textDecoration: 'none', color: view === 'subjects' ? 'var(--primary)' : 'inherit', display: 'flex', alignItems: 'center' }}>
        ...
        <div className="header-actions">
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <Link to="/upload-note" className="btn-primary" style={{ textDecoration: 'none', whiteSpace: 'nowrap' }}>
              Upload Note
            </Link>
          </div>
        </div>
        ...
        <main style={{ gridColumn: 'auto', width: '100%' }}>
                  ...
                  <div className="trending-grid">
                    {trendingNotes.map(note => (
                      <motion.div 
                        ...
                        whileHover={{ y: -5 }}
                        onClick={() => navigate(`/notes/${note.university?._id}/${note.subject?._id}`)}
                      >
              ...
              <div className="listings-grid">
                {loading ? <p>Loading universities...</p> : filteredUniversities.map(uni => (
                  <motion.div 
                    ...
                    onClick={() => navigate(`/notes/${uni._id}`)}
                  >
          ...
          {view === 'subjects' && (
            <div className="subjects-layout">
              <div style={{ flex: 1 }}>
                <button onClick={() => navigate('/notes')} className="btn-outline" style={{ marginBottom: '1rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', border: 'none', padding: 0, color: 'var(--text-muted)' }}>
                  ...
                  {loading ? <p>Loading courses...</p> : filteredSubjects.map(sub => {
                    ...
                    return (
                      <motion.div 
                        ...
                        onClick={() => navigate(`/notes/${universityId}/${sub._id}`)}
          ...
          {view === 'notes' && (
            <div>
              <button onClick={() => navigate(`/notes/${universityId}`)} className="btn-outline" style={{ marginBottom: '1.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div className="listings-grid">
                {loading ? <p>Loading notes...</p> : notes.length === 0 ? (
                  <div className="empty-state">
                    ...
                    <Link to="/upload-note" className="btn-primary" style={{ marginTop: '1rem', display: 'inline-block' }}>

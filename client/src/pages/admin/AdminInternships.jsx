...
const AdminInternships = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      learning: toArray(formData.learning),
    ...
    try {
      ...
      if (response.ok) {
        setStatus('success');
        setFormData({
          role: '', company: '', companyWebsite: '', logo: '', location: '', stipend: '', duration: '', deadline: '',
          category: 'Engineering', tags: '',
          workType: 'Full Time', workingDays: '5 Days/Week', userType: 'College Student',
          responsibilities: '', skills: [], optionalSkills: [], learning: '',
        ...
        setStatus('error');
        setErrorMessage(errorData.message || 'Failed to save internship');
      }
    } catch (error) {
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        ...
        <p className="page-subtitle">Add new comprehensive internship listings.</p>
      </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.5rem' }}>
              <div className="form-group">
                ...
                <input type="text" name="role" value={formData.role} onChange={handleChange} required placeholder="e.g. Frontend Developer" style={inputStyle} />
              </div>
              <div className="form-group">
                <label style={labelStyle}>Company Name</label>
                <input type="text" name="company" value={formData.company} onChange={handleChange} required placeholder="e.g. Google" style={inputStyle} />
              </div>
              <div className="form-group">
                <label style={labelStyle}>Company Website</label>
                <input type="text" name="companyWebsite" value={formData.companyWebsite} onChange={handleChange} placeholder="https://google.com" style={inputStyle} />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              <div className="form-group">
                ...
                <input type="text" name="stipend" value={formData.stipend} onChange={handleChange} required placeholder="e.g. ₹20,000/mo" style={inputStyle} />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1.5rem' }}>
              <div className="form-group">
                ...
                <input type="text" name="duration" value={formData.duration} onChange={handleChange} required placeholder="e.g. 3 Months" style={inputStyle} />
              </div>
              <div className="form-group">
            ...
            <div className="form-group">
              ...
              <textarea name="responsibilities" value={formData.responsibilities} onChange={handleChange} placeholder="Write code, Fix bugs, Attend meetings..." style={{ ...inputStyle, minHeight: '80px' }} />
            </div>
            ...
            <div className="form-group">
              <label style={labelStyle}>What You Will Learn (comma separated)</label>
              <textarea name="learning" value={formData.learning} onChange={handleChange} placeholder="Agile workflow, Team collaboration..." style={{ ...inputStyle, minHeight: '80px' }} />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              ...
              <div className="form-group">
                ...
                <input type="text" name="tags" value={formData.tags} onChange={handleChange} placeholder="Remote, Urgent, Paid" style={inputStyle} />
              </div>
            </div>
            ...
            >
              {status === 'loading' ? 'Saving...' : <><Save size={20} /> Save Internship</>}
            </button>

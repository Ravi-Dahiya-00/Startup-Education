...
const InternshipDetails = () => {
  ...
  // Theme State
  const [theme, setTheme] = useState(() => localStorage.getItem('internships-theme') || 'dark');
    ...
    const fetchInternship = async () => {
      if (location.state?.internship) {
        setInternship({
          ...
          responsibilities: location.state.internship.responsibilities?.length > 0 ? location.state.internship.responsibilities : mockInternship.responsibilities,
          skills: location.state.internship.skills?.length > 0 ? location.state.internship.skills : (location.state.internship.tags || mockInternship.skills),
          learning: location.state.internship.learning?.length > 0 ? location.state.internship.learning : mockInternship.learning,
          organizer: location.state.internship.organizer || mockInternship.organizer,
          workDetails: {
            days: location.state.internship.workingDays || mockInternship.workDetails.days,
            schedule: 'Flexible Work Hours',
            timing: location.state.internship.workType || mockInternship.workDetails.timing
          }
        });
        setLoading(false);
        return;
      ...
      try {
        ...
        if (response.ok) {
          ...
          setInternship({
            ...mockInternship,
            ...data,
            responsibilities: data.responsibilities?.length > 0 ? data.responsibilities : mockInternship.responsibilities,
            skills: data.skills?.length > 0 ? data.skills : (data.tags || mockInternship.skills),
            learning: data.learning?.length > 0 ? data.learning : mockInternship.learning,
            organizer: data.organizer || mockInternship.organizer,
            workDetails: {
              days: data.workingDays || mockInternship.workDetails.days,
              schedule: 'Flexible Work Hours',
              timing: data.workType || mockInternship.workDetails.timing
            }
          });
        } else {
  ...
  if (loading) {
    return (
      <div className={`internship-details-page ${theme}-theme`} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
          ...
          <div className="header-content">
            <div className="header-main">
              <div className="company-logo-large">
                <img 
                  src={internship.logo || mockInternship.logo} 
                  alt={internship.company} 
                  onError={(e) => {
                    e.target.src = mockInternship.logo;
                  }}
                />
              </div>
              <div className="header-info">
                ...
                <div className="company-meta">
                  ...
                  <span className="updated-badge">
                    <Clock size={14} />
                    Posted {new Date(internship.postedAt || Date.now()).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
                    ...
                    <div className="timeline">
                      <div className="timeline-item">
                        ...
                        <div className="timeline-content">
                          ...
                          <p>{new Date(internship.postedAt || Date.now()).toLocaleDateString()}</p>
                        </div>
                      </div>
          ...
          <div className="right-column">
            ...
            <div className="sidebar-card work-detail-card">
              ...
              <div className="detail-row">
                ...
                <span className="value">{internship.workDetails.days}</span>
              </div>
              <div className="detail-row">
                <span className="label">Schedule</span>
                <span className="value">{internship.workDetails.schedule}</span>
              </div>
              <div className="detail-row">
                <span className="label">Timing</span>
                <span className="value">{internship.workDetails.timing}</span>
              </div>
            </div>
          </div>
        </div>
